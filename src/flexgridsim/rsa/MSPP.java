 ...
 * @author Rafael
 */
public class MSPP implements RSA {
	...
	public void flowArrival(Flow flow) {
		...
		if (id >= 0) {
			...
			if (pathBack.getLinks() == null || pathBack.getSlotList().isEmpty()) {
				cp.blockFlow(flow.getID());
				return;
			}
			...
			ArrayList<LightPath> lightpathprotection = new ArrayList<LightPath>(); 
			lightpathprotection.add(vt.getLightpath(idc));

			cp.acceptFlow(flow.getID(),lightpath, lightpathprotection);
			//System.out.println("\n\n\n\n\n");
			return;
