...
public class CopyOfMultiGraph  {
	...
	public CopyOfMultiGraph(WeightedGraph G, PhysicalTopology pt, int demand, int nodes ) {
		this.pt = pt;
		this.G=G;
		this.demand =demand;
		this.numNodes = G.getNumNodes();
	...
	public void setAsUsed(int src, int dst, int core, int slot) {
		this.multiedges[src][dst][core][slot] = false;
		this.sharedMultiedges[src][dst][core][slot] = false;
	}
	/**
